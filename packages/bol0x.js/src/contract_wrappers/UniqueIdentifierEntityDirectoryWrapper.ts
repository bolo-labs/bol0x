...
import {
    UniqueIdentifierEntityDirectoryContract,
...
export class InternalUniqueIdentifierEntityDirectoryWrapper extends InternalEntityDirectoryWrapper
    ...
    protected async _getContractAsync(): Promise<
        UniqueIdentifierEntityDirectoryContract
    > {
...
export default class UniqueIdentifierEntityDirectoryWrapper extends InternalUniqueIdentifierEntityDirectoryWrapper
    implements IUniqueIdentifierEntityDirectoryWrapper {
    /** @inheritDoc */
    public subscribe<
        ArgsType extends UniqueIdentifierEntityDirectoryContractEventArgs
    >(
